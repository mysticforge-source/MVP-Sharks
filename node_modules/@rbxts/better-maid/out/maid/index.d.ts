...
export interface Maid<U extends object | void = void> {
	 ...
	 */
	on(signal: Signal<any> | RBXScriptSignal, callback: (...args: any[]) => void, disconnectName?: string): void;
